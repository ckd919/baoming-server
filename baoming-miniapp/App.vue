...
$shadow-md: 0 6rpx 24rpx rgba(0,0,0,0.06);
...
.btn-block { width: 100%; }
.btn-sm { padding: 10rpx 22rpx; font-size: 22rpx; border-radius: 40rpx; }
...
.form-input:focus { border-color: $primary; background: #fff; box-shadow: 0 0 0 4rpx rgba(255,107,53,0.08); }
...
.badge-success { background: #E8F8ED; color: #34C759; }
.badge-warning { background: #FFF2E8; color: #FF6B35; }
.badge-info { background: #E8F0FE; color: #007AFF; }
.badge-primary { background: #FFF5F0; color: #FF6B35; }
...
.empty-state .empty-icon { font-size: 80rpx; margin-bottom: 24rpx; opacity: 0.5; }
...
/* 头部渐变 */
.header-gradient {
  background: linear-gradient(160deg, #FF6B35, #FF8C5A);
  color: #fff;
